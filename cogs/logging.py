...
class Logging(commands.Cog):
    ...
    async def on_message_delete(self, message):
        if message.guild.id in [743073728853835828, 763493055771705385, 732525308661727243]:
    ...
    async def on_message_edit(self, before, after):
        ...
        if before.guild.id in [743073728853835828, 763493055771705385, 732525308661727243] and before.content != after.content:
